...
# predictable out-of-sample -- but the multipliers are deliberately set equal
# because that is what the training evidence supports.
ENABLE_REGIME = True
