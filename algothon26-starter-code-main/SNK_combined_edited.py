...
ALGO_BETA_WINDOW = 220
ALGO_Z_WINDOW = 85
ALGO_ENTRY_Z = 2.9000000000000004
ALGO_EXIT_Z = 0.41000000000000003
ALGO_ALLOC_FRACTION = 0.97

HEDGE_WINDOW = 340
Z_WINDOW = 95       # revised from 40 after 8-fold robustness testing
ENTRY_Z = 0.55
EXIT_Z = 0.19
...
CS_RESIDUAL_DAYS = 2
CS_K = 11
CS_REBALANCE_EVERY = 4
CS_ALLOC_FRACTION = 0.62
...
TS_ALLOC_FRACTION = 0.6799999999999999
...
MHRM_RIDGE_ALPHA = 24.900000000000002
MHRM_MIN_OBS = 90
MHRM_RIDGE_ALLOC_FRACTION = 0.89
MHRM_PREDICTION_THRESHOLD = 0.004
