...
Participants: write getMyPosition(prcSoFar) in SNK_7.py and update the imports below
...
import SNK_7  # import the module itself so we can read/write its tunable parameters
